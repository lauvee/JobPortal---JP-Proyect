...
import ExportExcelEmployees from "../../component/recruiter/ExportExcelEmployees";
...
const ApplicationTile = (props) => {
  ...
  const generatePDF = new JsPDF("portrait", "pt", "a4");
      ...
      >
        ...
        >
          {applications.length < 0 ? (
            ...
            <ExportExcelEmployees csvData={getData} fileName="E" />
          )}
        </Grid>
      </Grid>
      <FilterPopup
